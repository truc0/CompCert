...
Proof.
  ...
  eapply Mem.sup_include_trans; eauto. exploit Mem.support_alloc; eauto. intros EQ; rewrite EQ. right. auto.
Qed.
...
Proof.
  ...
  subst b. split. apply freshness. eapply Mem.sup_include_trans; eauto. apply Mem.sup_include_refl. rewrite B. left. auto.
  auto.
  right. exploit Mem.support_alloc; eauto. intros B. rewrite B in A.
  destruct A.
  split. intro. apply H2. right. auto. auto.
Qed.
...
Proof.
  ...
  unfold Mem.flat_inj in H. destruct (Mem.dec_sup (Mem.support m0) b1); inv H. auto.
