...
Variable function_entry: function -> list val -> mem -> env -> temp_env -> mem -> Z -> Prop.
...
Inductive step: state -> trace -> state -> Prop :=
  ...
  | step_internal_function: forall f vargs k m e le m1 sz,
      function_entry f vargs m e le m1 sz->
...
Inductive function_entry2 (ge: genv)  (f: function) (vargs: list val) (m: mem) (e: env) (le: temp_env)(m': mem)(sz:Z) : Prop :=
  | function_entry2_intro: forall m1,
      list_norepet (var_names f.(fn_vars)) ->
      list_norepet (var_names f.(fn_params)) ->
      list_disjoint (var_names f.(fn_params)) (var_names f.(fn_temps)) ->
      alloc_variables ge empty_env m f.(fn_vars) e m1 ->
      Mem.record_frame (Mem.push_stage m1) (Mem.mk_frame sz) = Some m' ->
      bind_parameter_temps f.(fn_params) vargs (create_undef_temps f.(fn_temps)) = Some le ->
      function_entry2 ge f vargs m e le m' sz.
