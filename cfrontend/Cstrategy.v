...
Lemma eval_simple_steps:
   (forall a v, eval_simple_rvalue e m a v ->
    ...
    star (Csem.step fn_stack_requirements)
         ge (ExprState f (C a) k e m)
...
with eval_funcall: mem -> fundef -> list val -> trace -> mem -> val -> Z -> Prop :=
  | eval_funcall_internal: forall m f vargs t e m1 m2 m3 out vres m4 sz m5 m6,
      ...
      exec_stmt e m3 f.(fn_body) t m4 out ->
