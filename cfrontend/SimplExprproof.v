...
(* return some 1 *)
  ...
  econstructor; eauto. constructor. auto.
(* return some 2 *)
  inv H11. exploit tr_top_val_for_val_inv; eauto. intros [A [B C]]. subst.
  econstructor; split.
...
(* skip return *)
  inv H10.
  assert (is_call_cont tk). inv H11; simpl in *; auto.
  econstructor; split.
