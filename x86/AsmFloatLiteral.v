...
Definition transf_def (iddef: ident * (AST.globdef UserAsm.fundef unit))
  : list (ident * (AST.globdef UserAsm.fundef unit)) :=
  match iddef with
  | (id, (Gvar v)) => [(id, (Gvar v))]
...
Definition transf_program (p: UserAsm.program) : program :=
