...
Proof.
    ...
    unfold Val.cmpu_bool; repeat destr;
    try (repeat (erewrite (valid_pointer_memiff1 _ _ H) in Heqb1); congruence);
    try (repeat (erewrite (valid_pointer_memiff1 _ _ H) in Heqb0); congruence).
Qed.
